...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { detail: @salon.detail, founder: @salon.founder, money: @salon.money, name: @salon.name } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { detail: @salon.detail, founder: @salon.founder, money: @salon.money, name: @salon.name } }
